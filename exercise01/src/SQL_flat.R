...
records[["marital_status_id"]] <- marital.statuses.id[ match(records[["marital_status_id"]], 
...
# Write data as csv in the data folder
write.csv(records, "../data/exercise01_flat.csv", row.names = FALSE)
