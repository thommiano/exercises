...
# This creates a column in sample size for the training data
train.sample <- nrow(train)
rforest.evaluation <- cbind(rforest.evaluation, train.sample)

# This creates a column in sample size for the validation data
validate.sample <- nrow(validate)
rforest.evaluation <- cbind(rforest.evaluation, validate.sample)
...
# This creates a column in sample size for the training data
train.sample <- nrow(train)
rforest.test <- cbind(rforest.test, train.sample)

# This creates a column in sample size for the validation data
test.sample <- nrow(test)
rforest.test <- cbind(rforest.test, test.sample)
